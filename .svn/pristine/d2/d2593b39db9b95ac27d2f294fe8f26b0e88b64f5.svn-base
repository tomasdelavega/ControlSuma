...
public class InventarioHelper extends GenericHelper {
	...
	public InventarioDTO convertEntityToDTO(Inventario entity) {
		...
		if (entity.getAreaFuncional() != null) {
			dto.setAreaFuncional(areaFuncionalHelper.convertEntityToDTO(entity
					.getAreaFuncional()));
		}

		if (entity.getInventarioOtra() != null) {
			dto.setInventarioOtra(inventararioOtrasHelper
					.convertEntityToDTO(entity.getInventarioOtra()));
		}
	...
	public Inventario convertDTOToEntity(InventarioDTO dto) {
		...
		if (dto.getAreaFuncional() != null
				&& dto.getAreaFuncional().getId() != null) {
			inv.setAreaFuncional(areaFuncionalHelper.convertDTOtoEntity(dto
					.getAreaFuncional()));
		}
		inv.setActivo(dto.getActivo());
		...
		if (dto.getResponsableGob() != null
				&& dto.getResponsableGob().getId() != null) {
			inv.setResponsableGob(personaHelper.convertDTOToEntity(dto
					.getResponsableGob()));
		}
		if (dto.getResponsableSUMA() != null
				&& dto.getResponsableSUMA().getId() != null) {
			inv.setResponsableSUMA(personaHelper.convertDTOToEntity(dto
					.getResponsableSUMA()));
		}
		if (dto.getUsuarioFinal() != null
				&& dto.getUsuarioFinal().getId() != null) {
			inv.setUsuarioFinal(personaHelper.convertDTOToEntity(dto
					.getUsuarioFinal()));
		}
		if (dto.getTecnologia() != null && dto.getTecnologia().getId() != null) {
			inv.setTecnologia(tecnologiaHelper.convertDTOToEntity(dto
					.getTecnologia()));
		}

		if (dto.getDesarrolladores() != null) {
			inv.setDesarrolladores(new ArrayList<InventarioPersona>());
			for (PersonaDTO perDTO : dto.getDesarrolladores()) {
				Persona persona = personaHelper.convertDTOToEntity(perDTO);
				InventarioPersona iPersona = new InventarioPersona();
				iPersona.setPersona(persona);
				inv.addInventarioPersona(iPersona);
