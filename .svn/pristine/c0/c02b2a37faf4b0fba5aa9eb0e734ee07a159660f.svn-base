			...
			<fieldset>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<form:input  path="codPersona" id="inputCodPersona" class="form-control" minlength="1" maxlength="30" placeholder="Código Persona"></form:input>
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<form:input  path="codJira" id="inputCodJira" placeholder="Código Jira" class="form-control" minlength="1" maxlength="30" disabled="false"></form:input>
						<div class="text-danger">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<form:input path="fechaUltMod" id="inputFechaUltMod" placeholder="Fecha Última Modificación" class="form-control" readonly="true"></form:input>
						<div class="text-danger">
				...
				<div class="col-md-4">
					<div class="form-group">
						...
						<form:input type="text" path="telefonoContacto" id="inputTelefonoContacto" maxlength="9" placeholder="Teléfono de Contacto" class="form-control"></form:input>
						<div class="text-danger">
