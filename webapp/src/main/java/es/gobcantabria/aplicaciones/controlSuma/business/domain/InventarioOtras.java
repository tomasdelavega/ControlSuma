...
public class InventarioOtras implements Serializable {
    ...
    @Column(name = "F_ULT_ACT_ANALISIS_FUNC", columnDefinition = "Date")
    ...
    @Column(name = "F_ULT_ACT_MANUAL_INSTAL", columnDefinition = "Date")
    ...
    @Column(name = "F_ULT_ACT_PLAN_PRUEBA", columnDefinition = "Date")
    ...
    @Column(name = "F_ULT_ACT_DISENO", columnDefinition = "Date")
