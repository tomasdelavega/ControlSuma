		...
		<div class="row-fluid">
						...
						<div class="row-fluid">
							<div class="col-md-2">
								<div class="input-prepend filterQuarterLine">
									...
									<form:input path="codTecnologia" id="inputCodTecnologia" cssClass="input-small input-usuario"	placeholder="Código de Tecnología" />
								</div>
							</div>
							<div class="col-md-2">
								<div class="input-prepend filterQuarterLine">
			...
			<div class="row-fluid">
				<div class="span12">
					<div class="pull-right">
						<br/>
						<a href="${pageContext.request.contextPath}/auth/tecnologia/add"  title="Añadir"><strong>Añadir Tecnología</strong></a>
					</div>
				</div>
				<div class="span12 form">
					<div class="display-table">
						<display:table name="listTecnologias" requestURI="" id="tecnologia" pagesize="10" class="table table-striped table-bordered table-hover" defaultsort="1" export="true" defaultorder="ascending">
							...
							<display:column property="codTecnologia" title="Código Tecnología" headerClass="sortable" sortable="true" />
							...
							<sec:authorize access="hasAnyRole('ROLE_CONTROLSUMA.GESTOR','ROLE_CONTROLSUMA.ADMIN')">
								<display:column media="html" title="Acciones">
									...
									<a href="${pageContext.request.contextPath}/auth/tecnologia/delete?id=${tecnologia.id}" class="btn btn-xs btn-info" title="Eliminar" onclick="return confirm('¿Estás seguro de eliminar ${tecnologia.codTecnologia} ?')">
