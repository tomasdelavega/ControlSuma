			...
			<div class="span12 form">
				...
				<div class="display-table">
					<display:table name="listRoles" requestURI="" id="rol" pagesize="10" class="table table-striped table-bordered table-hover" defaultsort="1" export="true" defaultorder="ascending">
						...
						<display:column property="fechaUltMod" title="Fecha de Última Modificación" headerClass="sortable" sortable="true" format="{0,date,MM/dd/yyyy}"/>
						<display:column property="descripcion" title="Descripción" headerClass="sorteable" sortable="true" />
						<sec:authorize access="hasAnyRole('ROLE_CONTROLSUMA.GESTOR','ROLE_CONTROLSUMA.ADMIN')">
							<display:column media="html" title="Acciones">
								...
								<a href="${pageContext.request.contextPath}/auth/rol/delete?id=${rol.id}" class="btn btn-xs btn-info" title="Eliminar" onclick="return confirm('¿Estás seguro de eliminar ${rol.nombre} ?')">
